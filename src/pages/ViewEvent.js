                ...
                <>
                    ...
                    <Container fluid className="d-flex flex-column align-items-center">
                        <Container fluid className="d-flex mt-3">
                            {event.image !== undefined && event.image !== '' && event.image !== null ? <img alt='' style={{ width: '75%', height: 'auto', objectFit: 'contain', margin: 'auto' }} src={event.image} /> : <img alt='' style={{ width: '75%', height: 'auto', objectFit: 'contain', margin: 'auto' }} src={eventimage} />}
                        </Container>
                        <Form style={{ marginLeft: '2.5%' }} className="w-100">
                            <Form.Group as={Row} className="w-75 text-light fw-bolder mt-5">
                                ...
                                <Form.Control style={{ fontSize: '0.9rem', resize: 'none' }} disabled plaintext className="text-light" defaultValue={event.description} as='textarea' rows={16} />
                            </Form.Group>
                        </Form>
                        <Form style={{ marginLeft: '2.5%' }} className="w-100">
                            <Form.Group as={Row} className="w-75 text-light fw-bolder mt-5">
